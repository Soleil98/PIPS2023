...
The make_art() function produces random artworks in R. It takes an optional argument which sets the seed for the randomly generated artwork to ensure its reproducibility. As in the set.seed() function, make_art() can take any integer numeric value.
